...
export class Demo extends Component {
  ...
  handleSaveFile = () => {
    // console.log(this.getFinalAndLatestInterimResult());
    let messages = this.getFinalAndLatestInterimResult();

    const results = messages
      .map((msg) =>
        msg.results.map((result, i) => (
          <span key={`result-${msg.result_index + i}`}>
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <ul className="base--ul">{micBullet}</ul>
        ...
        <div className="flex buttons">
          ...
          >
            <Icon
              ...
              fill={micIconFill}
            />{" "}
            {audioSource === "mic" ? "Stop" : "Start Transcribing"}
          </button>
          ...
          >
            ...
            {audioSource === "sample-1"
              ? "Stop Audio"
              : "Play Sample Meeting Audio"}
          </button>
