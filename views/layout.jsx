...
const DESCRIPTION = "Transcibe your Zoom Meetings with one click";
const GDPR_INFO =
...
const TERMS_OF_USE_URL =
  "https://watson-developer-cloud.github.io/terms?name=Speech-to-Text%20Demo";
...
export default function Layout({ children }) {
  return (
    <html lang="en">
      ...
      <body>
        <Header mainBreadcrumbs="Speech to Text" />
